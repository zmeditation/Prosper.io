      ...
      <DisclaimerContainer>
        <DisclaimerContent>
          <DisclaimerTitleWrapper>
            <p>PROSPER 247</p>Income Disclaimer
          </DisclaimerTitleWrapper>
          <DisclaimerTextBox>
            <DisclaimerContextTitle>
              Prosper 247 Earnings Disclaimer
            </DisclaimerContextTitle>
            ...
            <DisclaimerContextContent>
              By using our products and services you acknowledge and assume the risk that you may lose some or all of any cryptocurrency you place in your account via the purchase of packages or other means of transferring cryptocurrency from your personal account to that of www.prosper247.io. You also acknowledge that any commission earned is based solely on market conditions, legal and political climates, your own individual skills and experiences and any other conditions whether specifically mentioned in this disclaimer or not.
            </DisclaimerContextContent>
            <DisclaimerContextContent>
              Additionally, because of the volatile nature of the cryptocurrency markets you acknowledge that www.prosper247.io  has no means of accurately predicting market conditions, and as a result we cannot and do not guarantee that past performance is any indication of future performance and you acknowledge that the risk is 100% assumed by you once you choose to participate in any program or service.
            </DisclaimerContextContent>
            <DisclaimerContextTitle>
              Further Disclaimers
            </DisclaimerContextTitle>
            <DisclaimerContextContent>
              While we make every effort to ensure that we accurately represent all the products and services offered on this website and their potential for income, it should be noted that earnings and income statements made by www.prosper247.io and its sales materials, are estimates only of what we think you can possibly earn. There is no guarantee that you will make these levels of income and you accept the risk that the earnings and income statements differ by individual.
            </DisclaimerContextContent>
            <DisclaimerContextContent>
